...
namespace StackForge.Infrastructure.Data.Repositories
{
    public sealed class UserRegistrationRepository : IUserRegistrationRepository
    {
        ...
        public async Task<UserRegistration?> GetByUserId(Guid userId)
        {
            return await _context.UserRegistrations.FirstOrDefaultAsync(x => x.UserId == userId);
        }

        public void UpdateAsync(UserRegistration userRegistration)
        {
